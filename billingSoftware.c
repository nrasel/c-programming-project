...
// funcion to generate bill
void generateBillHeader(char name[50], char date[30])
{
    printf("\n\n");
    printf("\t    Kacchi Bhai Restaurant");
    printf("\n\t   -----------------");
    printf("\nDate:%s", date);
    printf("\nInvoice To: %s", name);
    printf("\n");
...
int main()
{
    ...
    while (contFlag == 'y')
    {
        ...
        printf("\n\nYour choice : \t");
        scanf("%d", &opt);
        fgetc(stdin); // scanf er porer statement kaj korbe na tai tai fgetc(stdin) diye akta slash comsume kore neoa hoise
        ...
        case 1:
            ...
            // to get current date usign strcpy
